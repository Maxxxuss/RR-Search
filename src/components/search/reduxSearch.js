...
import { defaultSearchStateSelector } from '../../redux/selectors/search'
...
export default function reduxSearch ({
  ...
  return createStore => (reducer, initialState) => {
    ...
    store[actions.searchStateSelector] = searchStateSelector
    ...
    if (resourceSelector) {
      ...
      store.subscribe(() => {
        ...
        const searchState = store[actions.searchStateSelector](nextState)
